                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div data-test-hook="basic">
                                            <select class="form-control" name="category-statu" id="category-statu">
                                                <option @if($category->statu == 1) selected @endif value="1">Aktif</option>
                                                <option @if($category->statu == 2) selected @endif value="2">Pasif</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div data-test-hook="basic">
                                        <select class="form-control" name="main-category" id="main-category">
                                            ...
                                            @foreach($maincategories as $maincategory)
                                                ...
                                                <option value="{{$maincategory->id}}" @if($maincategory->id == $category->main_category_id) selected @endif>{{$maincategory->name}}</option>
                                                @endif
                                                    @foreach($categories as $categori)
                                                    @if($categori->main_category_id == $maincategory->id && $categori->id != $category->id)
                                                        <option value="{{$categori->id}}" @if($categori->id == $category->main_category_id) selected @endif>{{$maincategory->name}} / {{$categori->name}}</option>
                                                    @endif
                                                @endforeach
                                            @endforeach
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" value="{{$category->slug}}" id="category-slug" type="text" placeholder="Kategori Linki">
                                            </div>
                                        </div>
