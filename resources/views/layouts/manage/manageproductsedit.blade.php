                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div data-test-hook="basic">
                                            <select class="form-control" name="product-type" id="product-type">
                                                <option @if($product->product_type == 0) selected @endif value="1">Fiziksel Ürün</option>
                                                <option @if($product->product_type == 1) selected @endif value="2">Dijital Ürün</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
