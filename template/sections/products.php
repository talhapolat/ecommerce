	...
	<div class="container">
		...
		<div class="flex-w flex-sb-m p-b-12">
			...
			<div class="flex-w flex-l-m filter-tope-group m-tb-10" >
				...
				<h3 id="collection" class="ltext-103 cl5">
				Koleksiyon
			</h3>
			</div>
		...
		<div class="row isotope-grid">
			...
			<?php  
				...
				if (isset($_GET["search-product"])) {
					$productQuery = $dbConnect->prepare("SELECT * FROM products WHERE title LIKE '%". $_GET["search-product"] ."%' and statu = '1'");
				} else {
					$productQuery = $dbConnect->prepare("SELECT * FROM products WHERE statu = '1'");
				}
				...
				<div class="block2">
					<div class="block2-pic hov-img0">
						<img src="/images/products/<?= $product["image"] ?>" alt="IMG-PRODUCT">
